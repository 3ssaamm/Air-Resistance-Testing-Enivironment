...
public class MarsLanderAirResistenceSimulationScaled : MonoBehaviour
{
    ...
    [SerializeField] private float scale = 0.001f; // Scale factor for the simulation (1:1000)
    ...
    {
        float width  = 6f*0.08f; // Width of the cube
        float height = 6f*0.08f; // Height of the cube
        float depth  = 6f*0.08f; // Depth of the cube
